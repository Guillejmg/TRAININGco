      ...
      <div className="carousel">
        <ul className='carousel__list'>
          <li className='carousel__item1-list'>
            <img className="carousel__img1-list" loading='lazy' src={gym1} alt="imagen del gimnasio 1" />
          </li>
          <li className='carousel__item2-list'>
            <img className="carousel__img2-list" loading='lazy' src={gym2} alt="imagen del gimnasio 2" />
          </li>
          <li className='carousel__item3-list'>
            <img className="carousel__img3-list" loading='lazy' src={gym1} alt="imagen del gimnasio 3" />
          </li>
        </ul>
